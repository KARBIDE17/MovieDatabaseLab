...
do
{
    ...
    List<MovieClass> searchResults = movieList.Where(movie => movie.Category.ToLower().Contains(userCategory)).ToList();

        foreach (MovieClass movie in searchResults)
        {
